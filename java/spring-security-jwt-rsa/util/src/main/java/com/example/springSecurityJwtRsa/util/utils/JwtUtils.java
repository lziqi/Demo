package com.example.springSecurityJwtRsa.util.utils;
...
public class JwtUtils {
    ...
    public static String generateJsonWebToken(UserEntity user, PrivateKey privateKey) {
        String token = Jwts
                .builder()
                .setSubject(SUBJECT)
     ...
     * @return
     */
    public static List<SimpleGrantedAuthority> getUserRole(String token,PublicKey publicKey) {
        Claims claims = Jwts.parser().setSigningKey(publicKey).parseClaimsJws(token).getBody();
